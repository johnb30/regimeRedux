...
emb = Reshape((300, 300), name='reshape_5d')(inputs)
#define the different filters
#conv_layer = []
#for each_length in filter_length:
conv = TimeDistributed(Convolution1D(nb_filters / 3, 3,
                                    # embedding_dims,
                                     border_mode='valid',
                                     activation='relu'),
                       input_shape=(300, 1, 300),
                       )(emb)

conv = TimeDistributed(MaxPooling1D(pool_length=3,
                                    border_mode='valid',
